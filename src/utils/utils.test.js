...
describe('getRouteAuthority tests', () => {
  it('should return authority for each route', () => {
    ...
    expect(getRouteAuthority('/admin', routes)).toEqual(['user']);
  ...
  it('should return inherited authority for unconfigured route', () => {
    ...
    expect(getRouteAuthority('/nested/admin', routes)).toEqual(['admin', 'user']);
  });
  it('should return authority for configured route', () => {
    ...
    expect(getRouteAuthority('/nested/admin', routes)).toEqual(['user']);
  ...
  it('should return authority for substring route', () => {
    ...
    expect(getRouteAuthority('/nested/admin', routes)).toEqual(['user']);
    expect(getRouteAuthority('/nested/admin', routes)).toEqual(['users']);
  });
});
